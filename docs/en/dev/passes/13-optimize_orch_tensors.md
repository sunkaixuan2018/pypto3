...
- explicit auto dependencies are added when a rewritten window output's buffer root is later read in the enclosing orchestration scope; this ensures correct synchronization between windowed writers and parent/root readers until the runtime has root-aware dependency tracking
